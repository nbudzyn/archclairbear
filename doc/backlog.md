...
## 1. Server liefert eine Startseite aus

Ziel:
Der Spring-Boot-Server soll eine HTML-Seite ausliefern, damit der Browser direkt über den Server geöffnet werden kann.

Warum:
Ohne ausgelieferte Startseite gibt es keinen gemeinsamen Einstiegspunkt für Client und Server. Für ein Running Skeleton ist das die Grundlage.

Ergebnis:
- `GET /` zeigt eine Seite im Browser.
- Die Seite kommt aus dem Spring-Boot-Projekt, nicht aus einer separaten lokalen Datei.

## 2. Eine minimale Client-Oberfläche anzeigen
...
## 3. Einen ersten API-Endpunkt für Graphdaten bereitstellen
...
## 4. Den ersten Knoten im Client rendern
...
## 5. Einfache Status- und Fehlermeldungen ergänzen
...
## 6. Einen kleinen Service zwischen Controller und Datenquelle einführen
...
## 7. Den Workspace-Pfad konfigurierbar machen
...
## 8. Den ersten echten Verzeichnisknoten aus dem Dateisystem ableiten
...
## 9. Einen Smoke-Test für den kompletten Startpfad ergänzen
...
## 10. Die nächste Ausbaustufe vorbereiten
